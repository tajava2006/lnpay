 ...
 *
 * reserve는 원래 "올려두고 잊는" 의뢰를 급락에서 지키는 장치다. 그런데
 ...
 * "컨펌 시점 고정이면 아무도 옵션을 못 쥔다"가 reserve로 뚫렸다.
 *
 ...
 * 금액별 요구 컨펌 수.
 *
 * 공격은 **고객이 자기 펀딩을 되돌리는 것**(T-105)이고, N컨펌을 되돌리려면 그만한

 ...
 * 내 키 백업·복원 (리뷰 #8)
 *
 * ⚠️ **지금은 어느 화면에도 붙어 있지 않다** (2026-09-24 운영자 결정). 이 키는 nostr 신원이라 라이트닝·
 * 온체인이 같이 쓴다 — 온체인에만 백업·교체가 있으면 두 트랙이 어긋나고, 진행 중 거래가 있는 채로 키가
 * 바뀌면 곤란하다. 키 백업·교체·파기는 나중에 두 트랙을 같이 놓고 제대로 기획한다. 그때 아래 근거를 다시 본다.
 *
 * ── 왜 온체인 트랙에 필요한가
 *
